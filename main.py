...
ASSISTANT_PROMPT = """
Sen son derece akıllı, zeki, analitik düşünen ve yardımcı bir yapay zeka asistanısın. Kullanıcıların sorularına net, doğru, kibar ve profesyonel düzeyde kapsamlı yanıtlar ver.
"""
...
async def about_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    about_text = (
        ...
        "Rusça-Türkçe çeviri ve akıllı asistan botuyum."
    )
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # 1. BOT ETİKETLENDİYSE -> AKILLI ASİSTAN MODU
    if is_mentioned:
        if not text:
...
async def error_handler(object, context: ContextTypes.DEFAULT_TYPE):
...
def main():
    ...
    logger.info("🤖 Viyana AI profesyonel çeviri ve asistan botu aktif!")
